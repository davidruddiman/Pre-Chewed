...
self.addEventListener('fetch', function(event) {
  ...
  var isCacheable = APP_SHELL.some(function(path) {
    return url.endsWith(path) || url.includes('/index.html') || url === self.location.origin + '/';
  }) || CDN_URLS.some(function(cdnUrl) {
    return url === cdnUrl;
  });
